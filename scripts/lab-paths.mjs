...
export function labPaths(repositoryRoot = resolve(fileURLToPath(new URL("..", import.meta.url)))) {
  ...
  return {
    ...
    pluginLink: join(profile, "node_modules", "dsh-azu-creator"),
    desktopHome,
    desktopProfile,
    ...
    desktopPluginLink: join(desktopProfile, "node_modules", "dsh-azu-creator"),
    desktopUserData,
    ...
    personalPluginLink: join(personalProfile, "node_modules", "dsh-azu-creator"),
    personalUserData,
