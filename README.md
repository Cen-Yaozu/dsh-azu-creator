...
内容管理已提供本地小闭环：点击“新建内容”，编辑并保存稿件，在“账号管理”登记一个或多个账号，再为内容选择目标账号、手动登记发布链接与时间。账号登记与这些记录不依赖 `video-publisher`，也不代表已登录或已核验平台身份。详见[本地内容管理](docs/content-management.md)。
