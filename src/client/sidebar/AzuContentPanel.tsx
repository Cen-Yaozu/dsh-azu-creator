...
import { AzuProjectCover } from "../AzuProjectCover.tsx";
      ...
      <div className="muziPanelList">
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              <AzuProjectCover id={item.id} title={item.title} revision={item.coverRevision} load={face.getProjectCover} className="muziContentCover" />
...
export const MuziContentPanel = AzuContentPanel;
