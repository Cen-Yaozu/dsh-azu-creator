...
import { AzuContentPanel } from "./AzuContentPanel.tsx";
import { TrellisProjectPanel } from "./TrellisProjectPanel.tsx";
import { AzBrand } from "./AzBrand.tsx";
import type { MzSidebarSlotProps } from "./slots.ts";
import "./AzSidebarRoot.css";
...
export type AzSidebarRootProps =
  & MzSidebarSlotProps
  & {
    ...
    >
      <div className="logoRow">
        {wide && (
          ...
          >
            <AzBrand name={t("brand.name")} tagline={t("brand.tagline")} />
          </IslandButton>
        )}
        ...
        >
          {!wide && <span className="railBrand"><AzBrand compact /></span>}
      ...
      >
        {wide && (
          <div className="tabRow">
            <div className="tabList" role="tablist" aria-orientation="vertical" aria-label="Azu 工作台导航">
              <IslandButton
      ...
      <div className="regionArea">
        ...
        {contentMounted && (
          <div className={cx("regionPane", !contentVisible && "hidden")}>
            <AzuContentPanel t={(key) => contentT(key as CreatorKey)} face={muziFace} resource={resources.content} />
          </div>
        )}
        {knowledgeMounted && (
