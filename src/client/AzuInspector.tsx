...
export interface AzuInspectorProps {
...
export type MuziInspectorProps = AzuInspectorProps;
...
export function AzuInspector({
  ...
  const sessionNeedsCommit = acceptanceSession !== null
    ...
    && !acceptanceCommitted;
  return (
    <article data-plugin="dsh-azu-creator" data-surface="muzi-inspector">
...
export const MuziInspector = AzuInspector;
