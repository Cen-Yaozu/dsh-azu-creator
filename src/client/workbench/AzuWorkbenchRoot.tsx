...
import { AzuInspector } from "../AzuInspector.tsx";
...
export type AzuWorkbenchRootProps = PropsRuntime<"conversation"> & {
...
export function AzuWorkbenchRoot({
  ...
  return (
    <main data-plugin="dsh-azu-creator" data-surface="central-workbench" data-feature={feature}>
...
export const MuziWorkbenchRoot = AzuWorkbenchRoot;
