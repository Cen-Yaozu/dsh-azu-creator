...
const EXTERNAL_ACTIONS: Readonly<Record<string, ExternalActionKind>> = Object.freeze({
  ...
  azu_sync_publish: "metrics",
  azu_creator_connect_account: "connection",
  azu_creator_reconnect_account: "connection",
  azu_creator_reopen_connection: "connection",
  azu_creator_open_account: "connection",
  azu_creator_prepare_publish_flow: "prepare",
  azu_creator_resume_publish_flow: "prepare",
  azu_creator_commit_publish_flow: "commit",
  azu_creator_begin_video_acceptance: "acceptance",
  azu_creator_finalize_video_acceptance: "acceptance",
  azu_creator_sync_video_metrics: "metrics",
